...
class Qwen2_5_VL_MOE_ForConditionalGeneration(Qwen2_5_VLPreTrainedModel, GenerationMixin):
...
__all__ = ["Qwen2_5_VL_MOE_ForConditionalGeneration", "Qwen2_5_VLModel", "Qwen2_5_VLPreTrainedModel"]
