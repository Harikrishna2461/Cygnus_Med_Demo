...
- en
---
# This is a decensored version of [google/medgemma-27b-text-it](https://huggingface.co/google/medgemma-27b-text-it), made using [Heretic](https://github.com/p-e-w/heretic) v1.0.1

> [!NOTE]
> Inspired by the thought of: _what if you could speak to an **offline** medical assistant that doesn't decline to answer some of your questions?_

## Abliteration parameters

| Parameter | Value |
| :-------- | :---: |
| **direction_index** | 42.36 |
| **attn.o_proj.max_weight** | 1.44 |
| **attn.o_proj.max_weight_position** | 37.63 |
| **attn.o_proj.min_weight** | 1.14 |
| **attn.o_proj.min_weight_distance** | 34.86 |
| **mlp.down_proj.max_weight** | 1.17 |
| **mlp.down_proj.max_weight_position** | 37.16 |
...
> [!IMPORTANT]
> datasets used for abliteration of this model **do not** contain medical docs/concepts etc. As such, the 'cost'/penalty of KL div increase vs the original model is **worse** than generalist models. This checkpoint chose to be **conservative** on amount of abliteration applied to preserve quality.
 
| Metric | This model | Original model ([google/medgemma-27b-text-it](https://huggingface.co/google/medgemma-27b-text-it)) |
| :----- | :--------: | :---------------------------: |
| **KL divergence** | 0.05 | 0 *(by definition)* |
