...
def run_clip_file_tests():
    ...
    latest_shunt_and_ligation_sample_data/data/<ShuntType>/ and verifies the
    ...
    data_root = pathlib.Path(__file__).parent / "latest_shunt_and_ligation_sample_data" / "data"
    if not data_root.exists():
        print("[SKIP] Clip-file tests: latest_shunt_and_ligation_sample_data/data not found")
        return
