...
def make_shunt_analyst() -> Agent:
    ...
    return Agent(
        ...
        backstory=(
            ...
            "SFJ competent; GSV refluxes into tributary only.\n"
            "TYPE 2B:  EP N2→N2 (perforator/SPJ entry, NOT SFJ). NO EP N1→N2. NO RP N2→N1. "
            "Perforator feeds system; drains via tributary only.\n"
            ...
            "OR same clips + RP N2→N1 + elimTest=No Reflux.\n"
            "TYPE 1+2: EP N1→N2 + EP N2→N3 + RP N3→N1 + RP N2→N1 + elimTest=Reflux. "
            "elim test is mandatory to separate from Type 3.\n"
