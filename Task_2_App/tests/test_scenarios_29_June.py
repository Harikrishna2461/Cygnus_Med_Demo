...
def write_word_report(all_results: dict[str, list[dict]],
    ...
    t = doc.add_heading(
        "CHIVA Streaming Guidance — 29 June Scenario Test Report", level=0)
...
def main():
    parser = argparse.ArgumentParser(
        description="CHIVA streaming guidance — 29 June scenario runner")
    ...
    if all_results:
        ...
        out_path = os.path.join(here, "results", f"scenarios_29June_{ts}.docx")
        try:
