...
class InternVL_MOE_Config(InternVLConfig):
    ...
    def __init__(self,fusion_mlp_config= None,**kwargs):
        ...
        if fusion_mlp_config is None:
            fusion_mlp_config = {"hidden_size": 2048, "intermediate_size": 1024,"hidden_act":"gelu"}
...
class InternVLModel(InternVLPreTrainedModel):
    ...
    def __init__(self, config: InternVL_MOE_Config):
        ...
        # self.usfm = DINOv3ViTModel.from_pretrained('/data/scy/SCY/SonoVLM_V2/data_generation/Miscellaneous_data/dinov3_usfm_final')
    ...
    def get_dinov3_and_usfm_image_features(self,dinov3_pixel_values: Optional[torch.Tensor] = None,#TODO
        ...
        dinov3_vision_features = self.dinov3(dinov3_pixel_values)
        # usfm_vision_features = self.usfm(dinov3_pixel_values)
        return dinov3_vision_features.last_hidden_state[:,5:,:]

    def fusion(self,dinov3_vision_features,vision_features,image_num_patches_indices):
        global_indices = image_num_patches_indices - 1  # [B]
        clip_vision_features = vision_features[global_indices]
        concat_feat = torch.cat([dinov3_vision_features, clip_vision_features], dim=-1)
    ...
    def get_image_features(
        ...
        **kwargs,
        ...
        vision_features = self.fusion(dinov3_vision_features,vision_features,image_num_patches_indices)
...
class InternVL_MOE_ForConditionalGeneration(InternVLPreTrainedModel, GenerationMixin):
...
__all__ = [
    ...
    "InternVLModel",
    "InternVL_MOE_ForConditionalGeneration",
]
