...
from .dinov3 import DINOv3ConvNextModel
...
class Qwen2_5_VL_MOE_Config(Qwen2_5_VLConfig):
    ...
    def __init__(self,**kwargs):
        self.moe_intermediate_size = 6#1408
        # self.shared_expert_intermediate_size = 6144#5376#5632
        self.num_experts = 3#total
...
@dataclass
class Qwen2_5_VL_MOE_CausalLMOutputWithPast(Qwen2_5_VLCausalLMOutputWithPast):
    """
    Base class for Qwen2_5_VL causal language model (or autoregressive) outputs.
